...
public interface Buffer<T> {
    ...
    /**
     * Liest und entfernt ein Element oder nach einem Timeout abbrechen. Falls der Puffer leer ist, warten bis ein Platz
     * belegt wird.
     *
     * @param millis Timeout bis zum Abbruch.
     * @return gelesenes Element.
    ...
    /**
     * Liest und entfernt das erste Element. Falls der Puffer leer ist, warten bis ein Platz belegt wird.
     *
     * @return gelesenes Element.
     * @throws InterruptedException falls das Warten unterbrochen wird.
     */
    ...
    /**
     * Liest und entfernt das letzte Element. Falls der Puffer leer ist, warten bis ein Platz belegt wird.
     *
     * @return gelesenes Element.
     * @throws InterruptedException falls das Warten unterbrochen wird.
     */
